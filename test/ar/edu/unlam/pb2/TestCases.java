...
public class TestCases {
	...
	public void queSePuedaCrearUnaTarjetaDeDebito() throws NumeroDeTarjetaInvalidoException{
		...
		assertEquals(SALDO_ESPERADO, ((TarjetaDeDebito) tarjetaDeDebito).getSaldo(),0.0);
	}
	...
	public void queSePuedaCrearUnaTarjetaDeCredito() throws NumeroDeTarjetaInvalidoException{
		...
		assertEquals(LIMITE_COMPRA_EN_PESOS,  ((TarjetaDeCredito) tarjetaDeCredito).getLimiteDeComprasEnPesos(),0.0);
		assertEquals(LIMITE_COMPRA_EN_DOLARES,  ((TarjetaDeCredito) tarjetaDeCredito).getLimiteDeCompraEnDolares(),0.0);
	}
	...
	System.out.println(elAlmacen.cuitValido(CUIT_ESPERADO));	
	...
	@Test
	public void queSePuedanAgregarDistintosMediosDePagoALaBilleteraDeUnConsumidor() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, NoCoincideTitularException, ConsumidorInexistente{
		// Preparaci�n 
		...
		mataGalan.agregarMedioDePago(27541231, new TarjetaDeCredito(5423542385612354L, "Luis Gomez", "10/10/2026", 153, 123213.0,12312312.0));
		mataGalan.agregarMedioDePago(27541231, new CuentaBancaria("01702046600000087865", "Nacion", "Luis Gomez"));
		mataGalan.agregarMedioDePago(27541231, new CuentaVirtual("00000003100036521571806", "Mercado Pago", "Luis Gomez"));
	...
	@Test
	public void queSePuedaPagarConUnaTarjetaDeCredito() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, ExcedeLimiteDeCompraException, NoCoincideTitularException, ConsumidorInexistente, CuitInvalidoException, ComercioInexcistente{
		// Preparaci�n 
		Billetera mataGalan = new Billetera("Ank");
		mataGalan.agregarConsumidor(new Consumidor(27541231, "Luis Gomez"));
		...
		Boolean resultado = mataGalan.pagar(codigoQR, mataGalan.consumidorBuscado(27541231),mataGalan.getMedioPagador(48332562153254623L));
	...
	@Test
	public void queSePuedaTransferirDeUnaCuentaAOtra() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, NoCoincideTitularException, ConsumidorInexistente{
		// Preparaci�n 
